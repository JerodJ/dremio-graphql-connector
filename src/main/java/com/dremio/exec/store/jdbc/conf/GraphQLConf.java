...
@SourceType(value = "GraphQLARP", label = "GraphQL",uiConfig = "graphql-layout.json")
public class GraphQLConf extends AbstractArpConf<GraphQLConf> {
  private static final String ARP_FILENAME = "arp/implementation/graphql-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.graphql.GraphQLDriver";
